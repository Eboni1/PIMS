...
INSERT INTO `backups` VALUES("2","Daily Backup","full","1","1","../backups/Daily Backup_2026-01-04_14-38-58","1","2026-01-04 20:38:58");
...
DROP TABLE IF EXISTS `online_backups`;
CREATE TABLE `online_backups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `type` enum('full','database','files') NOT NULL,
  `storage_type` enum('local','ftp','google_drive','dropbox') NOT NULL,
  `include_files` tinyint(1) DEFAULT 0,
  `include_database` tinyint(1) DEFAULT 0,
  ...
  PRIMARY KEY (`id`),
  KEY `created_by` (`created_by`),
  CONSTRAINT `online_backups_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
